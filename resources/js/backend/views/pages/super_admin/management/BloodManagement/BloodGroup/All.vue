                        ...
                        <table class="table table-hover text-center table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-start">SL</th><th>  name </th> 
<th>  description </th> 
                                        <th>status</th>
                                ...
                                <tbody v-if="all_data.data?.length">
                                    <tr v-for="(item, index) in all_data.data" :key="item.id">
                                        ...
                                        <td class="text-start">{{ index + 1 }}</td><th> {{ item.name}} </th> 
<th> {{ item.description}} </th> 
            ...
            import { blood_group_setup_store } from './setup/store';
            ...
            export default {
                ...
                methods: {
                    ...mapActions(blood_group_setup_store, {
                        get_all_data: 'all',
                        delete_data: 'delete',
                ...
                computed: {
                    ...mapState(blood_group_setup_store, {
                        all_data: 'all_data',
                    })
                }
            }
