                        ...
                        <table class="table table-hover text-center table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-start">SL</th><th>  blood_group_id </th> 
<th>  hospital_name </th> 
<th>  division_id </th> 
<th>  district_id </th> 
<th>  station_id </th> 
...
<th>  description </th> 
                                ...
                                <tbody v-if="all_data.data?.length">
                                    <tr v-for="(item, index) in all_data.data" :key="item.id">
                                        ...
                                        <td class="text-start">{{ index + 1 }}</td><th> {{ item.blood_group_id}} </th> 
<th> {{ item.hospital_name}} </th> 
<th> {{ item.division_id}} </th> 
<th> {{ item.district_id}} </th> 
<th> {{ item.station_id}} </th> 
<th> {{ item.phone}} </th> 
<th> {{ item.date}} </th> 
<th> {{ item.is_emergency}} </th> 
<th> {{ item.description}} </th> 
            ...
            import { post_for_blood_setup_store } from './setup/store';
            ...
            export default {
                ...
                methods: {
                    ...mapActions(post_for_blood_setup_store, {
                        get_all_data: 'all',
                        delete_data: 'delete',
                ...
                computed: {
                    ...mapState(post_for_blood_setup_store, {
                        all_data: 'all_data',
                    })
                }
            }
